        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="flex items-center mb-4">
              ...
              <span className="text-lg font-bold">LearnFi</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/learn" className="text-gray-400 hover:text-white text-sm transition-colors">
                  Learn DeFi
                </Link>
              </li>
              <li>
                <Link to="/simulate" className="text-gray-400 hover:text-white text-sm transition-colors">
                  Simulate Compound
                </Link>
              </li>
              <li>
                <Link to="/market-data" className="text-gray-400 hover:text-white text-sm transition-colors">
                  Market Data
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a 
                  href="https://github.com/compound-finance/compound-js" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="text-gray-400 hover:text-white text-sm transition-colors"
                >
