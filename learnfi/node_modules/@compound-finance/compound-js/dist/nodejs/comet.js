...
var address = constants_1.cometConstants.address, abi = constants_1.cometConstants.abi, decimals = constants_1.cometConstants.decimals, collaterals = constants_1.cometConstants.collaterals, base = constants_1.cometConstants.base;
...
function supply(from, dst, asset, amount, noApprove, options) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, helpers_1.netId(this._compoundInstance)];
                case 1:
                    _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    trxOptions = __assign({ _compoundProvider: this._compoundInstance._provider, abi: abi[this._compoundInstance._network.name].Comet }, options);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    cometAddress = address[this._compoundInstance._network.name][constants_1.constants.Comet];
                    trxOptions = __assign(__assign({}, options), { _compoundProvider: this._compoundInstance._provider, abi: abi[this._compoundInstance._network.name].Comet });
...
function withdraw(asset, amount, options) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, this._compoundInstance._provider.getAddress()];
                case 1:
                    src = _a.sent();
                    dst = src;
...
_compoundInstance) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, helpers_1.netId(_compoundInstance)];
                case 1:
                    _a.sent();
